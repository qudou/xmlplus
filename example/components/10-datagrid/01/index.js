xmlplus("xp", function (xp, $_, t) {
    ...
    $_("datagrid").imports({
        DataGrid: {
            css: "#datagrid { border: 2px solid #CC7A6F; border-radius: 3px; background-color: #fff; }\
                  #datagrid th { background-color: #CC7A6F; color: rgba(255,255,255,0.66); cursor: pointer; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; }\
